param (
    ...
    $hanastudioUri = $baseUri + "/SapBits/SAP_HANA_STUDIO/IMC_STUDIO2_246_0-80000323.SAR" 
    $jreUri = $baseUri + "/SapBits/SAP_HANA_STUDIO/jdk1.8.0_241.exe"
    $puttyUri = "https://the.earth.li/~sgtatham/putty/latest/w64/putty-64bit-0.73-installer.msi"
    $7zUri= $baseUri + "/SapBits/SAP_HANA_STUDIO/7z.msi"    
    $sapcardest = "C:\SapBits\SAP_HANA_STUDIO\sapcar.exe"
    $hanastudiodest = "C:\SapBits\SAP_HANA_STUDIO\IMC_STUDIO2_212_2-80000323.SAR"
    $jredest = "C:\Program Files\jdk1.8.0_241.exe"
    $puttydest = "C:\SapBits\SAP_HANA_STUDIO\putty-64bit-0.73-installer.msi"
    ...
    .\jdk1.8.0_241.exe -o"." -y
    
    cd $hanapath
    write-host "installing PuTTY"
    .\putty-64bit-0.73-installer.msi /quiet
    
    write-host "extracting and installing HANA Studio"
    .\sapcar.exe -xfv IMC_STUDIO2_212_2-80000323.SAR
    
    set PATH=%PATH%C:\Program Files\jdk1.8.0_241\bin;
